  ...
  return (
    <div className=" min-h-screen">
      <div className='flex h-[200px] border-t border-b'>
          <h2 className="text-5xl font-poppins font-semibold mt-[140px] ml-12">Payment</h2>
        </div>
    <div className='flex items-center justify-center mt-20'>
      <div className="w-[600px] p-8 bg-white shadow-2xl rounded-2xl">
        <h2 className="text-center text-3xl font-montserrat font-bold text-red-600">Complete Your Payment</h2>
        ...
        <div className="flex justify-between mb-6 mt-7">
          <button 
            ...
            className="flex items-center justify-center w-1/3 px-4 py-2 border border-red-300 rounded-md hover:bg-red-100 transition duration-200"
          >
          ...
          <button 
            ...
            className="flex items-center justify-center w-1/3 px-4 ml-5 py-2 border border-red-300 rounded-md hover:bg-red-100 transition duration-200"
          >
        ...
        <div className="flex items-center justify-center my-4">
          <span className="w-1/3 border-b border-red-300"></span>
        ...
        <form className="space-y-6">
          <div>
            ...
            <input 
              ...
              className="w-full px-3 py-2 mt-1 border border-red-300 rounded-md shadow-sm focus:outline-none focus:ring-red-500 focus:border-red-500 sm:text-sm"
            />
          ...
          <button 
            type="button" 
            className="w-full px-4 py-2 text-white bg-red-700 rounded-md focus:outline-none hover:from-red-500 hover:to-red-700 transition duration-200"
